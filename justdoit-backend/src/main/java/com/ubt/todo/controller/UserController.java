...
import com.ubt.todo.request.ForgotPasswordRequest;
import com.ubt.todo.request.RegistrationRequest;
import com.ubt.todo.request.ResetPasswordRequest;
...
public class UserController {
    ...
    public void userConfirmation(@PathVariable("token") String token) throws Exception {
        ...
        userService.userConfirmation(URLDecoder.decode(token, DEFAULT_ENCODER));
    }
